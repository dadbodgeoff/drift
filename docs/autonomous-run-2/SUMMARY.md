...
- **T123** GitHub Action (design-only) — Workflow authored as .github/workflows/drift-check.example.yml - named .example.yml so it does NOT run - plus docs/ci-integration.md stating exactly what is and is not verified. Nothing pushed.
