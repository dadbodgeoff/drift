...
export function helpText(parsed: ParsedArgs): string {
  ...
  return [
    ...
    "  2  blocked   new violation in a changed hunk, under a block-mode convention",
    "  3  refused   fail-closed: enforcement could not be performed, nothing is claimed",
    "  1  error     operational failure inside drift",
    "",
    "Global options:",
