...
impl FactKind {
    ...
    pub const ALL: &'static [FactKind] = &[
        ...
        FactKind::ExportAliasesImport,
        FactKind::ExportWrapsImport,
    ...
    pub fn as_wire(self) -> &'static str {
        match self {
            ...
            FactKind::ExportAliasesImport => "export_aliases_import",
            FactKind::ExportWrapsImport => "export_wraps_import",
            ...
            FactKind::SinkCandidateCalled => "sink_candidate_called",
    ...
    pub fn from_wire(value: &str) -> Option<Self> {
        match value {
            ...
            "export_aliases_import" => Some(FactKind::ExportAliasesImport),
            "export_wraps_import" => Some(FactKind::ExportWrapsImport),
            ...
            "sink_candidate_called" => Some(FactKind::SinkCandidateCalled),
...
impl GraphEdgeKind {
    ...
    pub fn as_wire(self) -> &'static str {
        match self {
            ...
            GraphEdgeKind::ModuleAliasesModule => "MODULE_ALIASES_MODULE",
    ...
    pub fn from_wire(value: &str) -> Option<Self> {
        match value {
            ...
            "MODULE_ALIASES_MODULE" => Some(GraphEdgeKind::ModuleAliasesModule),
