...
// docs/internal/autonomous-run-2/ so run 1's log stays an immutable record rather than being
// appended to.
const DIR = resolve(HERE, "..", process.env.DRIFT_RUN_DIR ?? "docs/internal/autonomous-run");
